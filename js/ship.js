...
class Ship {
	constructor() {
		...
		this.energy_per_move = 0; // PN This should be on the warp dive
		this.price = 0;
...
class TutorialShip extends Ship {
	constructor() {
		...
		this.price = 0;
		this.equipment = {WarpDrive}; // warp drive, stealth drive, 
...
class Trireme extends Ship {
	constructor() {
		...
		this.manufacturer = "Unknown";
		this.mass_capacity = .5; // metric tons
